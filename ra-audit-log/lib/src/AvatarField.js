 ...
 */
exports.AvatarField = function (props) {
    ...
    var src = get_1.default(record, source);
    var fullName = get_1.default(record, fullNameSource);
    if (!record) {
        return null;
    }
    return (React.createElement(EventAvatar_1.EventAvatar, __assign({ src: src, fullName: fullName, role: "presentation" }, rest)));
};
