...
exports.addEventsForMutations = void 0;
var constants_1 = require("../constants");
var buildMatchActionOnResource_1 = require("./buildMatchActionOnResource");
var options_1 = require("./options");
exports.addEventsForMutations = function (dataProvider, authProvider, options) {
    if (options === void 0) { options = options_1.DefaultOptions; }
    var _a = options.name, eventsResource = _a === void 0 ? constants_1.DefaultAuditLogResource : _a, _b = options.shouldAudit, shouldAudit = _b === void 0 ? buildMatchActionOnResource_1.buildMatchActionOnResource(options) : _b;
