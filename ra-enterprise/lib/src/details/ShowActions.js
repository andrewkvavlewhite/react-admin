...
exports.ShowActions = function (_a) {
    ...
    var _c = react_admin_1.useShowContext(rest), basePath = _c.basePath, record = _c.record;
    var hasEdit = react_admin_1.useResourceDefinition(rest).hasEdit;
    return (React.createElement(react_admin_1.TopToolbar, __assign({ className: className }, sanitizeRestProps(rest)),
        breadcrumb,
        hasEdit && React.createElement(react_admin_1.EditButton, { basePath: basePath, record: record })));
};
