...
exports.ListActions = function (props) {
    var breadcrumb = props.breadcrumb, className = props.className, exporter = props.exporter, filters = props.filters, rest = __rest(props, ["breadcrumb", "className", "exporter", "filters"]);
    ...
    return react_1.useMemo(function () { return (React.createElement(react_admin_1.TopToolbar, __assign({ className: className }, ra_core_1.sanitizeListRestProps(rest)),
        breadcrumb,
        filters
            ...
            : null,
        hasCreate && React.createElement(react_admin_1.CreateButton, { basePath: basePath }),
        exporter !== false && (React.createElement(react_admin_1.ExportButton, { disabled: total === 0, resource: resource, sort: currentSort, filterValues: filterValues })))); }, [resource, displayedFilters, filterValues, selectedIds, filters, total] // eslint-disable-line react-hooks/exhaustive-deps
    );
};
...
exports.ListActions.defaultProps = {
    breadcrumb: React.createElement(layout_1.Breadcrumb, { variant: "actions" }),
    selectedIds: [],
