...
var AccordionFormToolbar = function (props) {
    ...
    return (React.createElement(react_1.Fragment, null,
        React.createElement(Toolbar_1.default, __assign({ className: classnames_1.default(classes.toolbar, (_a = {},
            ...
            record && typeof record.id !== 'undefined' && (React.createElement(react_admin_1.DeleteButton, { basePath: basePath, record: record, resource: resource, undoable: undoable })))) : (react_1.Children.map(children, function (button) {
...
exports.default = withWidth_1.default({ initialWidth: 'xs' })(AccordionFormToolbar);
