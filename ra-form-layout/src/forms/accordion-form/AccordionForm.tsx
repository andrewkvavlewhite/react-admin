...
import { FormWithRedirect, Record, RedirectionSideEffect } from 'react-admin';
 ...
 * );
 */
const AccordionForm = (props: AccordionFormProps) => (
    <FormWithRedirect
        {...props}
        render={(formProps): ReactElement => (
            <AccordionFormView {...formProps} />
        )}
    />
);
