...
export declare type BreadcrumbVariant = 'default' | 'actions';
 ...
 *  );
 */
export declare const Breadcrumb: ({ children, className, variant, ...props }: BreadcrumbProps) => ReactElement;
declare type GetSeparatorFunction = () => string;
export {};
