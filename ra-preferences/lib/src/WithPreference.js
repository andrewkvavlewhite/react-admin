...
var WithPreference = function (_a) {
    ...
    var preference = usePreferences_1.default(path)[0];
    if (react_1.default.isValidElement(children)) {
        return react_1.default.cloneElement(children, __assign((_b = {}, _b[name || path] = preference, _b), rest));
    }
    else {
        throw new Error('Invalid child for WithPreferences. Expecting a valid React element');
    }
};
exports.default = WithPreference;
