...
var useSelectedColumns = function (_a) {
    ...
    var _b = usePreferences_1.default(preferences), columnsFromPrefs = _b[0], setColumnsFromPref = _b[1];
    ...
    return columnList.map(function (name) { return react_1.cloneElement(columns[name], { key: name }); });
};
exports.default = useSelectedColumns;
