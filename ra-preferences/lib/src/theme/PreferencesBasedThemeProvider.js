...
var PreferencesBasedThemeProvider = function (_a) {
    ...
    var type = __1.usePreferences('theme', 'light')[0];
    var theme = react_1.useMemo(function () { return themeFromType(type); }, [type] // eslint-disable-line react-hooks/exhaustive-deps
    );
    if (!react_1.isValidElement(children)) {
        throw new Error('PreferencesBasedThemeProvider must be used with a valid child');
    }
    return react_1.cloneElement(children, __assign({ theme: theme }, rest));
};
exports.default = PreferencesBasedThemeProvider;
