import { useEffect, FC, useRef, isValidElement, ReactElement } from 'react';
 ...
 */
const PreferencesSetter: FC<PreferencesSetterProps> = ({
    value,
    path,
    children,
}) => {
    const [_, setPreferences] = usePreferences(path);
