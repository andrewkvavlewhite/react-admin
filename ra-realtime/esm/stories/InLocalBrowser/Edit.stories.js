...
, __assign({ 
    // actions prop is only to add Realitime simulation buttons
    actions: React.createElement(EditActions, __assign({ dataProvider: localBrowserDataProvider }, props)) }, props),
    React.createElement(SimpleForm, null,
        React.createElement(TextInput, { source: "title" })))); };
export var Edit = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: localBrowserDataProvider, i18nProvider: i18nProvider },
