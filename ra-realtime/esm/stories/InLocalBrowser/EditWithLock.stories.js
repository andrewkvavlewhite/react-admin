...
export var EditWithLock = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: localBrowserDataProvider, i18nProvider: i18nProvider, customReducers: { locks: locks } },
