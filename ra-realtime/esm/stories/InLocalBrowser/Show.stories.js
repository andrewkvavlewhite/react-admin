...
, __assign({ 
    // actions prop is only to add Realitime simulation buttons
    actions: React.createElement(ShowActions, __assign({ dataProvider: localBrowserDataProvider }, props)) }, props),
    React.createElement(SimpleShowLayout, null,
        React.createElement(TextField, { source: "title" })))); };
export var Show = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: localBrowserDataProvider, i18nProvider: i18nProvider },
