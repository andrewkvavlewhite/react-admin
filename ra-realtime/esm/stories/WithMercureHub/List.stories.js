...
, __assign({ actions: React.createElement(ListActions, __assign({ dataProvider: mercureDataProvider }, props)) }, props),
    React.createElement(SimpleList, { primaryText: function (record) { return record.title; } }))); };
export var List = function () { return (React.createElement(Admin, { history: createMemoryHistory(), dataProvider: mercureDataProvider, i18nProvider: i18nProvider },
