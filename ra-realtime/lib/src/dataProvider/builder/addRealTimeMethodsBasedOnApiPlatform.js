...
var addRealTimeMethodsBasedOnApiPlatform = function (dataProvider, mercureURL, jwt, topicPrefix) {
    ...
    var subscriptions = [];
    var eventSources = {};
    var openEventSource = debounce_1.default(function (topic) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (!eventSource) {
                var params = jwt !== null
                    ...
                    : {};
                eventSource = new event_source_polyfill_1.EventSourcePolyfill(url, params);
...
exports.default = addRealTimeMethodsBasedOnApiPlatform;
/**
