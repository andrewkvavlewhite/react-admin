...
var addRealTimeMethodsBasedOnMercure = function (dataProvider, mercureURL, jwt, topicPrefix) {
    ...
    var subscriptions = [];
    var eventSource;
    var openEventSource = debounce_1.default(function () {
        ...
        return new Promise(function (resolve, reject) {
            eventSource = new event_source_polyfill_1.EventSourcePolyfill(url, {
...
exports.default = addRealTimeMethodsBasedOnMercure;
