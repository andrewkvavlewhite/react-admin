...
export declare type SubscriptionCallback<T = Event> = (event: T) => void;
...
export declare type GetOrdersListEvents = (Array: any) => void;
export interface RealTimeDataProvider {
    subscribe: (topic: string, subscriptionCallback: SubscriptionCallback) => Promise<any>;
    unsubscribe: (topic: string, subscriptionCallback: SubscriptionCallback) => Promise<any>;
