...
, __assign({ actions: react_1.default.createElement(__1.ListActions, __assign({ dataProvider: realTimeDataProvider_1.localBrowserDataProvider }, props)) }, props),
    react_1.default.createElement(react_admin_1.SimpleList, { primaryText: function (record) { return record.title; } }))); };
exports.List = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: realTimeDataProvider_1.localBrowserDataProvider, i18nProvider: i18nProvider_1.default },
