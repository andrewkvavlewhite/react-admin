...
, __assign({ 
    // actions prop is only to add Realitime simulation buttons
    actions: react_1.default.createElement(__1.ShowActions, __assign({ dataProvider: realTimeDataProvider_1.localBrowserDataProvider }, props)) }, props),
...
exports.Show = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: realTimeDataProvider_1.localBrowserDataProvider, i18nProvider: i18nProvider_1.default },
