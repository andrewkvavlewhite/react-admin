...
exports.mercureDataProvider = exports.localBrowserDataProvider = void 0;
var ra_data_fakerest_1 = __importDefault(require("ra-data-fakerest"));
var builder_1 = require("../src/dataProvider/builder");
...
var mercureDataProvider = builder_1.addLocksMethodsBasedOnALockResource(builder_1.addRealTimeMethodsBasedOnMercure(dataProvider, 'http://localhost/.well-known/mercure', JWT));
exports.mercureDataProvider = mercureDataProvider;
var baseDataProvider = builder_1.addLocksMethodsBasedOnALockResource(builder_1.addRealTimeMethodsInLocalBrowser(dataProvider));
...
exports.localBrowserDataProvider = localBrowserDataProvider;
