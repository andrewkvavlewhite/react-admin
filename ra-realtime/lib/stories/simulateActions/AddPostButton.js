...
var AddPostButton = function (props) {
    ...
    var handleClick = function () {
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dataProvider.create('posts', {
                            data: { title: makeTitle(10) },
                        })];
                    case 1:
                        newPost = (_a.sent()).data;
                        topic = 'resource/posts';
                        dataProvider.publish(topic, {
                            type: 'created',
                            topic: topic,
                            payload: { ids: [newPost.id] },
                            date: new Date(),
                        });
                        return [2 /*return*/];
                }
    ...
    return (react_1.default.createElement(react_admin_1.Button, __assign({ color: "primary", onClick: handleClick, label: "Post Creation" }, props),
