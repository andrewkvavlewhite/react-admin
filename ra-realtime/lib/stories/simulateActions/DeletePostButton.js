...
var DeletePostButton = function (props) {
    var dataProvider = react_admin_1.useDataProvider();
    var handleClick = function () {
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            var id, posts, topic, topicList;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!props.record) return [3 /*break*/, 1];
                        id = props.record.id;
                        return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, dataProvider.delete('posts', {
                            id: id,
                            previousData: props.record,
                        })];
                    case 4:
                        _a.sent();
                        topic = "resource/posts/" + id;
                        ...
                        topicList = "resource/posts";
                        dataProvider.publish(topicList, {
                            type: 'deleted',
                            topic: topicList,
                            payload: { ids: [id] },
                            date: new Date(),
    ...
    return (react_1.default.createElement(react_admin_1.Button, __assign({ color: "primary", onClick: handleClick, label: "Post Deletion" }, props),
