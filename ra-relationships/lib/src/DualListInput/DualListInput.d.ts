...
import { ChoicesProps, InputProps, ClassesOverride } from 'react-admin';
/**
 ...
 * ];
 */
export declare const DualListInput: FC<DualListInputProps>;
interface Props {
    choices?: any;
    className?: string;
    disableValue?: string;
...
export declare type DualListInputProps = Props & Omit<ChoicesProps, 'choices'> & Omit<InputProps, 'source'>;
declare const useStyles: (props?: any) => Record<"button" | "root" | "list" | "actions" | "addButton" | "removeButton" | "listHeader" | "selectedList" | "availableList", string>;
export {};
