...
var ReferenceManyToManyField = function (_a) {
    ...
    var _c = useReferenceManyToManyFieldController_1.default({
        filter: props.filter,
        perPage: perPage,
        record: props.record,
    ...
    return (react_1.default.createElement(react_admin_1.ListContextProvider, { value: __assign(__assign({}, referenceManyToManyProps), { 
...
exports.default = ReferenceManyToManyField;
