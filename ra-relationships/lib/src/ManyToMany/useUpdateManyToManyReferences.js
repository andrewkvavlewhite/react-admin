...
exports.useUpdateManyToManyReferences = exports.computeReferencesDiff = void 0;
var react_1 = require("react");
var react_admin_1 = require("react-admin");
var constants_1 = require("./constants");
exports.computeReferencesDiff = function (previousReferences, newReferences) {
...
exports.useUpdateManyToManyReferences = function () {
    var dataProvider = react_admin_1.useDataProvider();
    var notify = react_admin_1.useNotify();
    return react_1.useCallback(function (_a, _b) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _e.trys.push([0, 6, , 7]);
                        _c = using.match(constants_1.UsingRegexp), sourceField_1 = _c[1], targetField_1 = _c[2];
                    ...
                    case 1:
                        ...
                        _d = exports.computeReferencesDiff(previousReferences, newReferences), addedReferences = _d.addedReferences, removedReferences_1 = _d.removedReferences;
                        ...
                        return [4 /*yield*/, dataProvider.deleteMany(through, {
                                ...
                                action: react_admin_1.DELETE_MANY,
                            })];
                    case 2:
                        _e.sent();
                        _e.label = 3;
