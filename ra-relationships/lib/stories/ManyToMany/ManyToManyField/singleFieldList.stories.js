...
exports.LoadedWithData = function () { return (react_1.default.createElement(ra_test_1.TestContext, { initialState: initialState },
    react_1.default.createElement(src_1.ReferenceManyToManyField, { label: "performances", resource: addon_knobs_1.text('resource', 'bands'), source: addon_knobs_1.text('source', 'id'), reference: addon_knobs_1.text('reference', 'venues'), through: addon_knobs_1.text('through', 'performances'), using: addon_knobs_1.text('using', 'band_id,venue_id'), record: data_1.default.bands[0] },
