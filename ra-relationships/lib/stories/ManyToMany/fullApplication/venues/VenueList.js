...
var VenueList = function (props) {
    return (react_1.default.createElement(react_admin_1.List, __assign({}, props, { sort: { field: 'name', order: 'ASC' } }),
        react_1.default.createElement(react_admin_1.Datagrid, null,
            ...
            react_1.default.createElement(react_admin_1.TextField, { source: "location" }),
            react_1.default.createElement(src_1.ReferenceManyToManyField, { source: "id", label: "Bands", reference: "bands", through: "performances", using: "venue_id,band_id" },
