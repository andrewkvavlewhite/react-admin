 ...
 * );
 */
export declare const SearchResultItem: <RecordType extends unknown = DefaultContent>(props: SearchResultItemProps<RecordType>) => ReactElement;
interface GetValueFromRecordFunction<RecordType extends any = SearchResultDataItem> {
    (record?: RecordType): ReactNode;
}
declare type StringOrFunctionOrElement<RecordType extends unknown = DefaultContent> = string | ReactElement | GetValueFromRecordFunction<SearchResultDataItem<RecordType>>;
interface SearchResultItemProps<RecordType extends unknown = DefaultContent> extends Omit<ListItemProps, 'button'> {
