...
import { SearchDataProvider } from '../types';
/**
 ...
 */
export declare const addSearchMethod: (dataProvider: DataProvider, options?: AddSearchMethodOptions) => SearchDataProvider;
declare type AddSearchMethodResourceOptionsMap = Record<string, AddSearchMethodResourceOptions>;
export declare type AddSearchMethodOptions = string[] | AddSearchMethodResourceOptionsMap;
export interface GetValueFromRecordFunction<RecordType extends RaRecord = RaRecord> {
    (record?: RecordType): string;
}
export declare type AddSearchMethodResourceOptions = {
