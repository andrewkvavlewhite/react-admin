...
exports.useSearch = function (defaultOptions) {
    var _a = react_admin_1.useSafeSetState(initialState), state = _a[0], setState = _a[1];
    ...
    var search = react_1.useCallback(function (query, options) {
        if (!query) {
