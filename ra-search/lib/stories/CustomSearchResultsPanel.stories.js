...
exports.CustomSearchResultsPanel = void 0;
...
var MySearchResultsPanel = function () {
    var _a = src_1.useSearchResults(), data = _a.data, onClose = _a.onClose;
    return (React.createElement("ul", { style: { maxHeight: '250px' } }, data.map(function (item) { return (React.createElement("li", { key: item.id },
        React.createElement(react_router_dom_1.Link, { to: item.url, onClick: onClose },
...
exports.CustomSearchResultsPanel = function () { return (React.createElement(react_admin_1.Admin, { dataProvider: dataProvider_1.dataProvider, i18nProvider: i18nProvider_1.default, layout: MyLayout },
