...
var MyAppbar = function (props) {
    ...
    return (React.createElement(react_admin_1.AppBar, __assign({}, props),
        ...
        React.createElement(src_1.Search, { options: { historySize: 3 } })));
};
...
exports.ChangeSizeTo3 = function () { return (React.createElement(react_admin_1.Admin, { dataProvider: dataProvider_1.dataProvider, i18nProvider: i18nProvider_1.default, layout: MyLayout },
