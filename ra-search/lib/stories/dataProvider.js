...
exports.dataProviderWithAutoSearch = exports.dataProvider = exports.baseDataprovider = void 0;
...
exports.baseDataprovider = ra_data_fakerest_1.default(data, true);
// search only in song title and artist name
exports.dataProvider = __assign(__assign({}, exports.baseDataprovider), { search: function (query, options) {
...
exports.dataProviderWithAutoSearch = src_1.addSearchMethod(exports.baseDataprovider, {
    artists: {},
    songs: {
