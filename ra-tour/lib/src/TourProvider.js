...
var Tour_1 = __importDefault(require("./Tour"));
...
var TourProvider = function (_a) {
    ...
    var _e = react_1.useReducer(reducer_1.default, initialState || {
        running: false,
        stepIndex: 0,
        activeTour: null,
    ...
    return (react_1.default.createElement(exports.StateContext.Provider, { value: state },
        react_1.default.createElement(exports.DispatchContext.Provider, { value: actions },
            react_1.default.createElement(Tour_1.default, { joyrideProps: joyrideProps, tours: tours }),
            children)));
};
exports.default = TourProvider;
