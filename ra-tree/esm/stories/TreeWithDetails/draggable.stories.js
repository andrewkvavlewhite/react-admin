...
var CategoriesList = function (props) { return (React.createElement(TreeWithDetails, __assign({ draggable: true, titleField: "name", edit: CategoriesEdit, create: CategoriesCreate }, props))); };
...
export default { title: 'ra-tree/TreeWithDetails/Draggable' };
