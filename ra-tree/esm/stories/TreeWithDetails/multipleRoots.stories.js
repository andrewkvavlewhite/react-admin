...
var CategoriesList = function (props) { return (React.createElement(TreeWithDetails, __assign({ titleField: "name", edit: CategoriesEdit, create: CategoriesCreate, allowMultipleRoots: true }, props))); };
...
export default { title: 'ra-tree/TreeWithDetails/Multiple Roots' };
