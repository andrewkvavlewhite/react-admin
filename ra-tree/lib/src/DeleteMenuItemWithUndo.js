...
var DeleteMenuItemWithUndo = react_1.forwardRef(function (_a, ref) {
    ...
    var _d = controllers_1.useDeleteBranchWithUndoController({
        record: record,
        resource: resource,
        redirect: redirectTo,
        basePath: basePath,
    ...
    return (React.createElement(core_1.MenuItem, __assign({ className: className, disabled: loading, onClick: handleDelete, ref: ref }, props), translate(label, { _: label })));
});
...
exports.default = DeleteMenuItemWithUndo;
