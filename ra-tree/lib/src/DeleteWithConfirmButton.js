...
var DeleteWithConfirmButton = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(react_admin_1.Button, __assign({ onClick: handleDialogOpen, label: label, className: classnames_1.default('ra-delete-button', classes.deleteButton, className), key: "button" }, rest), icon),
