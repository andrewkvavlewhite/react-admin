...
var DeleteWithUndoButton = function (props) {
    ...
    return (React.createElement(react_admin_1.Button, __assign({ onClick: handleDelete, disabled: loading, label: label, className: classnames_1.default('ra-delete-button', classes.deleteButton, className), key: "button" }, rest), icon));
};
