...
exports.useTreeController = void 0;
var react_redux_1 = require("react-redux");
var react_admin_1 = require("react-admin");
var dataProvider_1 = require("../dataProvider");
var util_1 = require("../util");
var actions_1 = require("../actions");
exports.useTreeController = function (options) {
    ...
    var treeState = dataProvider_1.useGetTree(resource, {
        enabled: !lazy,
        version: version,
    });
    // load only the root nodes on mount if lazy
    var rootNodesState = dataProvider_1.useGetRootNodes(resource, {
        enabled: lazy,
        version: version,
    });
    ...
    var tree = data
        ? util_1.getRCTree(data, titleField, translate('ra-tree.new_node'), hideRootNodes)
        : null;
    // handle expanded persistence
    var dispatch = react_redux_1.useDispatch();
    var expandedKeys = react_redux_1.useSelector(function (state) {
        return state.tree[resource] ? state.tree[resource].expanded : [];
    });
    // prepare hooks for drag and drop
    var moveAsNthChildOf = dataProvider_1.useMoveAsNthChildOf(resource)[0];
    var moveAsNthSiblingOf = dataProvider_1.useMoveAsNthSiblingOf(resource)[0];
    var refreshTree = dataProvider_1.useGetTreeCallback(resource);
    ...
    var handleExpand = function (expandedKeys) {
        ...
        dispatch(actions_1.changeExpandedNodes(resource, expandedKeys));
    };
