...
export declare type TreeRecordWithChildren = WithChildren<TreeRecordWithChildren> & Record;
...
export interface TreeDataProvider {
    getTree: (resource: string, params: any) => Promise<{
        data: TreeRecord[];
    }>;
    getRootNodes: (resource: string, params: any) => Promise<{
        data: TreeRecord[];
    }>;
    getParentNode: (resource: string, params: {
        childId: Identifier;
    }) => Promise<{
        data: TreeRecord;
    }>;
    getChildNodes: (resource: string, params: GetChildNodesParams) => Promise<{
        data: TreeRecord[];
    }>;
    moveAsNthChildOf: (resource: string, params: {
        source: TreeRecord;
    ...
    moveAsNthSiblingOf: (resource: string, params: {
        source: TreeRecord;
        destination: TreeRecord;
        position: number;
    }) => Promise<{
    ...
    addRootNode: (resource: string, params: {
        data: Partial<TreeRecord>;
    }) => Promise<{
        data: TreeRecord;
    }>;
    addChildNode: (resource: string, params: {
        parentId: Identifier;
        data: Partial<TreeRecord>;
    }) => Promise<{
        data: TreeRecord;
    }>;
    deleteBranch: (resource: string, params: {
        id: Identifier;
        data: Record;
    }) => Promise<{
        data: Record;
