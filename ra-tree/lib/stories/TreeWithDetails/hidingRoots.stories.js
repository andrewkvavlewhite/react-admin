...
var CategoriesList = function (props) { return (react_1.default.createElement(src_1.TreeWithDetails, __assign({ titleField: "name", edit: CategoriesEdit, create: CategoriesCreate_1.default, hideRootNodes: true }, props))); };
exports.HideRootNodes = function () { return (react_1.default.createElement(react_admin_1.Admin, { history: history_1.createMemoryHistory(), dataProvider: dataProvider_1.default, i18nProvider: i18nProvider_1.default, customReducers: { tree: src_1.reducer } },
...
exports.default = { title: 'ra-tree/TreeWithDetails/HideRootNodes' };
