...
var CategoriesList = function (props) { return (react_1.default.createElement(src_1.TreeWithDetails, __assign({ titleField: "name", showLine: true, edit: CategoriesEdit_1.default, create: CategoriesCreate_1.default }, props))); };
...
exports.default = { title: 'ra-tree/TreeWithDetails/Show Line' };
